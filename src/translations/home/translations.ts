export const translations = {
  ...
  "pt-br": {
    ...
    introduction:
      "Durante meus três anos como estudante de engenharia de software, desenvolvi fortes habilidades críticas e analíticas, entregando consistentemente resultados de alta qualidade em projetos com curtos prazos.",
    viewProjects: "Ver Projetos",
    readAboutMe: "Ler Sobre Mim",
    aboutMe:
